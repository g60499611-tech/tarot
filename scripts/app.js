...
// ========================================
const TAROT_CARDS = [
    { id: 0, name: "愚人", nameEn: "The Fool", image: "fool.jpg", meaning: "新的开始、冒险、纯真、自发性" },
    { id: 1, name: "魔术师", nameEn: "The Magician", image: "magician.jpg", meaning: "创造力、技能、意志力、显化" },
    { id: 2, name: "女祭司", nameEn: "The High Priestess", image: "high_priestess.jpg", meaning: "直觉、潜意识、神秘、内在智慧" },
    { id: 3, name: "皇后", nameEn: "The Empress", image: "empress.jpg", meaning: "丰饶、母性、创造力、自然" },
    { id: 4, name: "皇帝", nameEn: "The Emperor", image: "emperor.jpg", meaning: "权威、结构、父性、控制" },
    { id: 5, name: "教皇", nameEn: "The Hierophant", image: "hierophant.jpg", meaning: "传统、信仰、教育、精神指引" },
    { id: 6, name: "恋人", nameEn: "The Lovers", image: "lovers.jpg", meaning: "爱情、和谐、选择、价值观" },
    { id: 7, name: "战车", nameEn: "The Chariot", image: "chariot.jpg", meaning: "意志力、胜利、决心、控制" },
    { id: 8, name: "力量", nameEn: "Strength", image: "strength.jpg", meaning: "勇气、耐心、内在力量、同情心" },
    { id: 9, name: "隐士", nameEn: "The Hermit", image: "hermit.jpg", meaning: "内省、孤独、寻求真理、指引" },
    { id: 10, name: "命运之轮", nameEn: "Wheel of Fortune", image: "wheel_of_fortune.jpg", meaning: "变化、命运、周期、转折点" },
    { id: 11, name: "正义", nameEn: "Justice", image: "justice.jpg", meaning: "公正、平衡、真理、因果" },
    { id: 12, name: "倒吊人", nameEn: "The Hanged Man", image: "hanged_man.jpg", meaning: "牺牲、等待、新视角、放下" },
    { id: 13, name: "死神", nameEn: "Death", image: "death.jpg", meaning: "转变、结束、新生、释放" },
    { id: 14, name: "节制", nameEn: "Temperance", image: "temperance.jpg", meaning: "平衡、调和、耐心、中庸" },
    { id: 15, name: "恶魔", nameEn: "The Devil", image: "devil.jpg", meaning: "束缚、欲望、物质主义、阴影面" },
    { id: 16, name: "塔", nameEn: "The Tower", image: "tower.jpg", meaning: "突变、觉醒、破坏、启示" },
    { id: 17, name: "星星", nameEn: "The Star", image: "star.jpg", meaning: "希望、灵感、宁静、指引" },
    { id: 18, name: "月亮", nameEn: "The Moon", image: "moon.jpg", meaning: "幻觉、恐惧、潜意识、直觉" },
    { id: 19, name: "太阳", nameEn: "The Sun", image: "sun.jpg", meaning: "快乐、成功、活力、清晰" },
    { id: 20, name: "审判", nameEn: "Judgement", image: "judgement.jpg", meaning: "重生、觉醒、宽恕、评估" },
    { id: 21, name: "世界", nameEn: "The World", image: "world.jpg", meaning: "完成、整合、成就、圆满" }
];
